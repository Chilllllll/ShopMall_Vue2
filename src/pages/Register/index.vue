    ...
    <div class="register">
      ...
      <div class="controls">
        <input
          ...
          v-model="check"
          name="check"
          v-validate="{ required: true, check: true }"
          :class="{ invalid: errors.has('check') }"
        />
        <span>同意协议并注册《尚品汇用户协议》</span>
        <span class="error-msg">{{ errors.first("check") }}</span>
      </div>
      <div class="btn">
    ...
    async userRegister() {
      ...
      if (success) {
        try {
          ...
          const { phone, code, password, passwordConfirm, check } = this;
